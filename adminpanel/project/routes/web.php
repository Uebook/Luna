...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:products'], function () {
        Route::get('/gift-card/datatables', 'Admin\GiftCardController@datatables')->name('admin-giftcard-datatables');
        Route::get('/gift-card', 'Admin\GiftCardController@index')->name('admin-giftcard-index');
        Route::get('/gift-card/create', 'Admin\GiftCardController@create')->name('admin-giftcard-create');
        Route::post('/gift-card/store', 'Admin\GiftCardController@store')->name('admin-giftcard-store');
    ...
    //------------ ADMIN LIVE STREAM SECTION ------------
    Route::group(['middleware' => 'permissions:products'], function () {
        Route::get('/livestream/datatables', 'Admin\LiveStreamController@datatables')->name('admin-livestream-datatables');
        Route::get('/livestream', 'Admin\LiveStreamController@index')->name('admin-livestream-index');
        Route::get('/livestream/create', 'Admin\LiveStreamController@create')->name('admin-livestream-create');
        Route::post('/livestream/store', 'Admin\LiveStreamController@store')->name('admin-livestream-store');
        Route::get('/livestream/{id}/start', 'Admin\LiveStreamController@start')->name('admin-livestream-start');
        Route::get('/livestream/{id}/show', 'Admin\LiveStreamController@show')->name('admin-livestream-show');
        Route::get('/livestream/{id}/products', 'Admin\LiveStreamController@products')->name('admin-livestream-products');
        Route::get('/livestream/{id}/products/available', 'Admin\LiveStreamController@getAvailableProducts')->name('admin-livestream-products-available');
        Route::post('/livestream/{id}/products/add', 'Admin\LiveStreamController@addProduct')->name('admin-livestream-products-add');
        Route::post('/livestream/{id}/products/{productId}/remove', 'Admin\LiveStreamController@removeProduct')->name('admin-livestream-products-remove');
        Route::post('/livestream/{id}/products/update-order', 'Admin\LiveStreamController@updateProductOrder')->name('admin-livestream-products-update');
        Route::get('/livestream/{id}/end', 'Admin\LiveStreamController@endStream')->name('admin-livestream-end');
        Route::delete('/livestream/{id}/delete', 'Admin\LiveStreamController@destroy')->name('admin-livestream-delete');
    });
    //------------ ADMIN LIVE STREAM SECTION ENDS------------

    //------------ ADMIN CELEBRITY SECTION ------------
    Route::group(['middleware' => 'permissions:customers'], function () {
        Route::get('/celebrity/datatables', 'Admin\CelebrityController@datatables')->name('admin-celebrity-datatables');
        Route::get('/celebrity', 'Admin\CelebrityController@index')->name('admin-celebrity-index');
        Route::get('/celebrity/create', 'Admin\CelebrityController@create')->name('admin-celebrity-create');
        Route::post('/celebrity/create', 'Admin\CelebrityController@store')->name('admin-celebrity-store');
        Route::get('/celebrity/{id}/show', 'Admin\CelebrityController@show')->name('admin-celebrity-show');
        Route::get('/celebrity/{id}/edit', 'Admin\CelebrityController@edit')->name('admin-celebrity-edit');
        Route::post('/celebrity/{id}/update', 'Admin\CelebrityController@update')->name('admin-celebrity-update');
        Route::delete('/celebrity/{id}/delete', 'Admin\CelebrityController@destroy')->name('admin-celebrity-delete');
    });
    //------------ ADMIN CELEBRITY SECTION ENDS ------------
    ...
    Route::group(['middleware' => 'permissions:menu_page_settings'], function () {
        ...
        //------------ ADMIN PRODUCT FAQ SECTION (CHATBOT) ------------
        Route::group(['middleware' => 'permissions:products'], function () {
            Route::get('/product-faq/datatables', 'Admin\ProductFaqController@datatables')->name('admin-product-faq-datatables');
            Route::get('/product-faq', 'Admin\ProductFaqController@index')->name('admin-product-faq-index');
            Route::get('/product-faq/create', 'Admin\ProductFaqController@create')->name('admin-product-faq-create');
            Route::post('/product-faq/create', 'Admin\ProductFaqController@store')->name('admin-product-faq-store');
            Route::get('/product-faq/edit/{id}', 'Admin\ProductFaqController@edit')->name('admin-product-faq-edit');
            Route::post('/product-faq/update/{id}', 'Admin\ProductFaqController@update')->name('admin-product-faq-update');
            Route::delete('/product-faq/delete/{id}', 'Admin\ProductFaqController@destroy')->name('admin-product-faq-delete');
        });
        //------------ ADMIN PRODUCT FAQ SECTION ENDS ------------
    ...
    //------------ ADMIN Story SETTINGS SECTION ------------

    Route::group(['middleware' => 'permissions:story'], function () {

        Route::get('/story/datatables', 'Admin\StoryController@datatables')->name('admin-story-datatables');
        Route::get('/story', 'Admin\StoryController@index')->name('admin-story-index');
        Route::get('/story/{id}', 'Admin\StoryController@edit')->name('admin-story-edit');
        Route::post('/story/{id}', 'Admin\StoryController@update')->name('admin-story-update');
        Route::get('/story/create/new', 'Admin\StoryController@create')->name('admin-story-create');
        Route::post('/story/store/new',  'Admin\StoryController@store')->name('admin-story-store');
        Route::delete('/story/{id}', 'Admin\StoryController@destroy')->name('admin-story-delete');
    });

    //------------ ADMIN story SETTINGS SECTION ENDS ------------
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    // CELEBRITY ADMIN SECTION
    Route::prefix('celebrity')->group(function () {
        Route::get('/login', 'Celebrity\CelebrityAuthController@showLoginForm')->name('celebrity.login');
        Route::post('/login', 'Celebrity\CelebrityAuthController@login')->name('celebrity.login.submit');
        Route::get('/logout', 'Celebrity\CelebrityAuthController@logout')->name('celebrity.logout');

        Route::middleware('auth:celebrity')->group(function () {
            Route::get('/dashboard', 'Celebrity\CelebrityDashboardController@index')->name('celebrity.dashboard');
            
            // Products
            Route::get('/products/datatables', 'Celebrity\CelebrityProductController@datatables')->name('celebrity.products.datatables');
            Route::get('/products', 'Celebrity\CelebrityProductController@index')->name('celebrity.products.index');
            Route::get('/products/create', 'Celebrity\CelebrityProductController@create')->name('celebrity.products.create');
            Route::post('/products', 'Celebrity\CelebrityProductController@store')->name('celebrity.products.store');
            Route::get('/products/{id}/edit', 'Celebrity\CelebrityProductController@edit')->name('celebrity.products.edit');
            Route::post('/products/{id}', 'Celebrity\CelebrityProductController@update')->name('celebrity.products.update');
            Route::delete('/products/{id}', 'Celebrity\CelebrityProductController@destroy')->name('celebrity.products.delete');
        });
    });
    // CELEBRITY ADMIN SECTION ENDS
