...
<li>
    <a href="{{ route('admin-product-faq-index') }}" class=" wave-effect"><i class="fas fa-comments"></i>{{ __('Product FAQs (Chatbot)') }}</a>
</li>
...
<li>
    <a href="{{ route('admin-giftcard-index') }}" class=" wave-effect"><i class="fas fa-gift"></i>{{ __('Gift Cards') }}</a>
</li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="vendor" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin-story-index') }}"><span>Story</span></a>
        </li>
    </ul>
</li>
...
<li>
    <a href="#celebrity" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="fas fa-star"></i>{{ __('Celebrities') }}
    </a>
    <ul class="collapse list-unstyled" id="celebrity" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-celebrity-index') }}"><span>{{ __('Celebrities List') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-celebrity-create') }}"><span>{{ __('Add Celebrity') }}</span></a>
        </li>
        <li>
            <a href="{{ route('celebrity.login') }}" target="_blank"><span>{{ __('Celebrity Login Page') }}</span></a>
        </li>
    </ul>
</li>

<li>
    <a href="{{ route('admin-livestream-index') }}" class=" wave-effect"><i class="fas fa-video"></i>{{ __('Live Streams') }}</a>
</li>
...
<li>
    <a href="{{ route('admin.fonts.index') }}" class=" wave-effect"><i class="fa fa-font"></i>{{ __('Font Option')
        }}</a>
</li>
