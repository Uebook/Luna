                        ...
                        <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        ...
                                        <div class="action-list">
                                            ...
                                            <a class="add-btn edit-product"
                                                data-href="{{ route('admin-order-product-edit',[$itemKey, $product['item']['id'],$order->id]) }}"
                               ...
                               $order_shipping = @json_decode($order->vendor_shipping_id, true);
                                ...
                                $order_shipping =PriceHelper::convertToArray($order_shipping);
                                
                                $order_package = @json_decode($order->vendor_packing_id, true);
                                $order_package =PriceHelper::convertToArray($order_package);
