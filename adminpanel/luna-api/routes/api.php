...
Route::controller(WalletController::class)->prefix('v1/wallet')->group(function () {
    ...
    Route::post('/purchase-history', 'getPurchaseHistory');
    Route::post('/reward-transactions', 'getRewardTransactions');
    Route::post('/send-gift', 'sendGift');
    Route::post('/redeem-gift', 'redeemGift');
    Route::post('/received-gifts', 'getReceivedGifts');
});

Route::controller(VoucherController::class)->prefix('v1/voucher')->group(function () {
    Route::post('/get-user-vouchers', 'getUserVouchers');
    Route::post('/collect', 'collectVoucher');
});

Route::controller(GiftCardController::class)->prefix('v1/gift-card')->group(function () {
    Route::get('/get-all', 'getGiftCards');
    Route::post('/purchase', 'purchaseGiftCard');
    Route::post('/get-user-gift-cards', 'getUserGiftCards');
