...
class Order extends Model
{
	 protected $fillable = [
        ...
        'customer_email', 'customer_name', 'customer_country', 'customer_phone',
        'customer_address', 'customer_city', 'customer_zip', 'shipping_name',
        'shipping_country', 'shipping_email', 'shipping_phone', 'shipping_address',
        'shipping_city', 'shipping_zip', 'order_note', 'coupon_code', 'coupon_discount',
        'status', 'affilate_user', 'affilate_charge', 'currency_sign', 'currency_name',
        'currency_value', 'shipping_cost', 'packing_cost', 'tax', 'tax_location',
        'dp', 'pay_id', 'vendor_shipping_id', 'vendor_packing_id', 'vendor_ids',
        'wallet_price', 'is_shipping', 'shipping_title', 'packing_title',
        'customer_state', 'shipping_state', 'discount', 'affilate_users',
        'commission', 'riders'
    ];
