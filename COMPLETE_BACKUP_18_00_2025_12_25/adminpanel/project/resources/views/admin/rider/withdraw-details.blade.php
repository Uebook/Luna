                    ...
                    <div class="body-area">
                        ...
                        <div class="table-responsive show-table">
                            <table class="table">
                                <tr>
                                    <th>{{ __("Rider ID#") }}</th>
                                    <td>{{$withdraw->rider->id}}</td>
                                </tr>
                                <tr>
                                    <th>{{ __("Rider Name") }}</th>
                                    <td>
                                        <a href="{{route('admin-rider-show',$withdraw->rider->id)}}"
                                            target="_blank">{{$withdraw->rider->name}}</a>
                                    </td>
                                </tr>
                                <tr>
                                    <th>{{ __("Withdraw Amount") }}</th>
                                    <td>{{ \PriceHelper::showAdminCurrencyPrice($withdraw->amount * $sign->value) }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{$withdraw->rider->email}}</td>
                                </tr>
                                <tr>
                                    <th>{{ __("Rider Phone") }}</th>
                                    <td>{{$withdraw->rider->phone}}</td>
                                </tr>
                                <tr>
