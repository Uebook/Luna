...
import GiftCardReceivedScreen from '../screen/GiftCardReceivedScreen';
...
import ProductChatBotScreen from '../screen/ProductChatBotScreen';
import AgoraLiveStreamScreen from '../screen/AgoraLiveStreamScreen';
import AgoraLiveViewerScreen from '../screen/AgoraLiveViewerScreen';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator
        ...
        <Stack.Screen name="GiftCardReceivedScreen" component={GiftCardReceivedScreen} />
        ...
        <Stack.Screen name="AgoraLiveStreamScreen" component={AgoraLiveStreamScreen} />
        <Stack.Screen name="AgoraLiveViewerScreen" component={AgoraLiveViewerScreen} />
