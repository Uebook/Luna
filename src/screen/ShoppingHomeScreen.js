...
const celebrities = [
    { name: 'Bader Almotawaa', image: 'https://randomuser.me/api/portraits/men/12.jpg' },
    { name: 'Fahad Alaradi', image: 'https://randomuser.me/api/portraits/men/13.jpg' },
    { name: 'Ahmed Alreyahi', image: 'https://randomuser.me/api/portraits/men/14.jpg' },
    { name: 'Bader Almotawaa', image: 'https://randomuser.me/api/portraits/men/12.jpg' },
    { name: 'Fahad Alaradi', image: 'https://randomuser.me/api/portraits/men/13.jpg' },
    { name: 'Ahmed Alreyahi', image: 'https://randomuser.me/api/portraits/men/14.jpg' }
];
...
const ShoppingHomeScreen = ({ navigation }) => (
    <ScrollView style={styles.container}>
        ...
        <View style={styles.header}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('ActivityScreen')} style={styles.myActivityButton}>
            ...
            <View style={styles.headerIcons}>
                ...
                >
                    <Icon name="notifications-outline" size={30} style={{ marginLeft: 10 }} />
                </TouchableOpacity>
            </View>
        </View>
        ...
        <FlatList
            ...
            renderItem={({ item }) => <Image source={{ uri: item }} style={styles.circleAvatar} />}
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginVertical: 10 }}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('ShopScreen')} >
                <Text style={[styles.sectionTitle, { color: '#004BFE', fontSize: 14 }]}>View All</Text>
            </TouchableOpacity>
        </View>
        ...
        <FlatList
            ...
            data={dummyProducts}
            renderItem={({ item }) => (
                <TouchableOpacity onPress={() => navigation.navigate('ProductDetailScreen')} style={styles.productCard}>
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginVertical: 10 }}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('CategoriesFilterScreen')} >
                <Text style={[styles.sectionTitle, { color: '#004BFE', fontSize: 14 }]}>View All</Text>
            </TouchableOpacity>
        </View>
        ...
        <FlatList
            ...
            renderItem={({ item }) => (
                <View style={[styles.productCard, { width: (width - 48) / 2, margin: 8 }]}>
                    <Image source={{ uri: item.image }} style={styles.productImage} />
                    <Text numberOfLines={2} style={styles.productTitle}>{item.title}</Text>
                    <Text>{item.price}</Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    myActivityButton: { backgroundColor: '#007bff', padding: 8, borderRadius: 16, marginLeft: 12 },
    myActivityText: { color: '#fff' },
    headerIcons: { flexDirection: 'row', marginLeft: 'auto' },
    sectionTitle: { fontSize: 18, fontWeight: 'bold', paddingHorizontal: 16, marginTop: 24, color: '#000', paddingBottom: 10 },
    announcementBox: { backgroundColor: '#f1f1f1', margin: 16, padding: 12, borderRadius: 10, position: 'relative' },
    announcementTitle: { fontWeight: 'bold', fontSize: 16 },
    announcementText: { fontSize: 14, color: '#555', marginTop: 4 },
    blueCircle: { position: 'absolute', right: 16, top: 16, backgroundColor: '#007bff', borderRadius: 16, padding: 8 },
    circleAvatar: { width: 60, height: 60, borderRadius: 50, margin: 10 },
    celebrityWrapper: { flexDirection: 'row', paddingHorizontal: 16, flexWrap: 'wrap' },
    celebrityCard: { width: (width - 64) / 3, alignItems: 'center', marginBottom: 16 },
    ...
    productTitle: { fontSize: 14, fontWeight: 'bold', marginVertical: 4, color: '#000' },
    popularCard: { width: 140, backgroundColor: '#fff', borderRadius: 10, marginRight: 16, shadowColor: '#000', shadowOpacity: 0.1, shadowOffset: { width: 0, height: 2 }, shadowRadius: 4, elevation: 3, overflow: 'hidden' },
    popularImage: { width: '100%', height: 160, resizeMode: 'cover' },
    popularMeta: { flexDirection: 'row', justifyContent: 'space-between', padding: 8 },
    ...
    categoryBox: { width: (width - 48) / 2, backgroundColor: '#fff', borderRadius: 12, padding: 8, marginBottom: 16, shadowColor: '#000', shadowOpacity: 0.1, shadowOffset: { width: 0, height: 2 }, shadowRadius: 4, elevation: 3 },
