...
const dummyProducts = [
    { title: 'Floral Dress', price: '$27.99', image: require('../assets/image3.png') },
    { title: 'Denim Jacket', price: '$42.00', image: require('../assets/image4.png') },
...
const mostPopular = [
    { title: 'Green Jacket', subtitle: 'New', likes: 1780, image: 'https://picsum.photos/id/1021/200' },
    { title: 'Beige Coat', subtitle: 'Sale', likes: 1780, image: 'https://picsum.photos/id/1022/200' },
    { title: 'Yellow Sweater', subtitle: 'Hot', likes: 1780, image: 'https://picsum.photos/id/1023/200' }
];
...
const NewHome = ({ navigation }) => (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <FlatList
            ...
            renderItem={({ item }) => <Image source={item?.image} style={styles.circleAvatar} />}
        ...
        <FlatList
            ...
            renderItem={({ item }) => (
                <TouchableOpacity onPress={() => navigation.navigate('ProductDetailScreen')} style={styles.productCard}>
                    ...
                    <Text style={{ fontWeight: "700", fontSize: 15, color: '#000' }} >{item.price}</Text>
                </TouchableOpacity>
            )}
            contentContainerStyle={{ paddingHorizontal: 16 }}
        />
        ...
        <View style={styles.flashSaleContainer}>
            <View style={styles.flashSaleHeader}>
                ...
                <View style={styles.timerBox}>
                    <Icon name="time-outline" size={16} color="#004BFE" style={{ marginRight: 4 }} />
            ...
            <View style={styles.flashGrid}>
                {dummyProductss.map((item, index) => (
                    <TouchableOpacity onPress={() => navigation.navigate('FlashSaleScreen')} key={index} style={styles.flashCard}>
...
const styles = StyleSheet.create({
    ...
    bannerWrapper: { marginHorizontal: 16, marginBottom: 20, borderRadius: 16, overflow: 'hidden', position: 'relative' },
    ...
    sectionTitle: { fontSize: 18, fontWeight: 'bold', color: '#000', paddingHorizontal: 16, paddingTop: 20 },
    ...
    celebrityName: { fontSize: 14, color: '#000', marginTop: 4, textAlign: 'center' },
    ...
    popularCard: {
        width: 140, backgroundColor: '#fff', borderRadius: 10, marginRight: 16,
