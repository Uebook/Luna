    ...
    const LegendPill = ({ color, label, amount, percent, index }) => {
        ...
        return (
            <TouchableOpacity
                ...
                activeOpacity={0.8}
                style={[styles.legendPill, { borderColor: color }, active && { backgroundColor: '#F7FAFF' }]}
            >
...
const styles = StyleSheet.create({
    ...
    yearChip: {
        ...
        backgroundColor: '#fff', borderWidth: 1, borderColor: '#DDE5FF',
    },
    yearChipActive: { backgroundColor: '#E9F0FF', borderColor: PALETTE.brand },
    ...
    monthStrip: {
        ...
        paddingHorizontal: 4, paddingVertical: 6, backgroundColor: '#F7FAFF',
        borderRadius: 14, borderWidth: 1, borderColor: '#E7EEFF',
    },
    arrowBtn: {
        width: 36, height: 36, borderRadius: 18, borderWidth: 1,
        borderColor: '#E0E7FF', backgroundColor: '#fff',
        alignItems: 'center', justifyContent: 'center',
    },
    monthRow: { paddingHorizontal: 8, gap: 10 },
    monthChip: {
        paddingHorizontal: 16, paddingVertical: 10, borderRadius: 16,
        backgroundColor: '#fff', borderWidth: 1, borderColor: '#E6EDFF', marginRight: 8,
    },
    ...
    centerDisk: {
        ...
        backgroundColor: '#fff', borderWidth: 1, borderColor: '#EDF2FF',
        ...Platform.select({
    ...
    tooltipLine: { color: '#334155', fontWeight: '700' },
    ...
    legendPill: {
        ...
        borderRadius: 12, borderWidth: 1.5, backgroundColor: '#fff',
        flexDirection: 'row', alignItems: 'center',
    },
    dot: { width: 10, height: 10, borderRadius: 5, marginRight: 8 },
    legendLabel: { color: PALETTE.text, fontWeight: '800' },
    legendSub: { color: '#6B7280', fontWeight: '700', marginTop: 2 },
    ...
    statOuter: {
        width: 70, height: 70, borderRadius: 35, backgroundColor: '#F4F6FF',
        alignItems: 'center', justifyContent: 'center',
        ...Platform.select({
